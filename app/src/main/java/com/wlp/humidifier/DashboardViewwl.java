...
public class DashboardViewwl extends View {
    ...
    public DashboardViewwl(Context context) {
        this(context, null);
    }

    public DashboardViewwl(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DashboardViewwl(Context context, AttributeSet attrs, int defStyleAttr) {
