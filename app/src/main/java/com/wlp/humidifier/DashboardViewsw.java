...
public class DashboardViewsw extends View {
    ...
    private String mHeaderText = "水量"; // 表头
   private int mCreditValue; // 信用分
    ...
    public DashboardViewsw(Context context) {
        this(context, null);
    }

    public DashboardViewsw(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DashboardViewsw(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        mTexts = new String[]{"0", "0.5", "1", "1.5", "2", "2.5", "3", "3.5", "4", "4.5", "5"};
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isAnimFinish) {
            ...
            mPaint.setShader(generateSweepGradient());
            canvas.drawArc(mRectFProgressArc, mStartAngle + 1,
                    mAngleWhenAnim - mStartAngle - 1, false, mPaint);
            /**
             * 画信用值指示亮点
             */
            float[] point = getCoordinatePoint(
     ...
     * @param creditValue 信用值
     */
    public void setCreditValueWithAnim(int creditValue) {        //参数入口
