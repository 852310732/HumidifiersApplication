...
public class InstrumentViewwl extends View {
    ...
    public InstrumentViewwl(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public InstrumentViewwl(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        canvas.drawText("当前进度："+progress+"%",);
        ...
        canvas.drawText("雾量", centerPoint[0], baseLine1, mPaint);
